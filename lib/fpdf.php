...
function SetWidths($w)
		...
		function RowTitulo($data)
	{
		...
		$this->SetFillColor( 32, 122, 158 );//Fondo azul
	...
	function Row($data)
	{
		...
		for($i=0;$i<count($data);$i++)
		{
			...
			$y=$this->GetY();
			//Draw the border
			//$this->Rect($x,$y,$w,$h); // es para poner la linea
	...
	function RowLL($data)// sin border
	{
		//Calculate the height of the row
		$nb=0;
		for($i=0;$i<count($data);$i++)
	...
	function CheckPageBreak($h)
	{
		...
		$this->SetFillColor(16, 88, 118);//Fondo verde de celda
